...
class Ui_codertool(object):
    def setupUi(self, codertool):
        ...
        self.push_refresh = QtWidgets.QPushButton(self.tab)
        self.push_refresh.setGeometry(QtCore.QRect(100, 210, 112, 34))
    ...
    def retranslateUi(self, codertool):
        ...
        self.push_refresh.setText(_translate("codertool", "刷新当前页面"))
