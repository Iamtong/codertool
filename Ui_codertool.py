...
class Ui_codertool(object):
    def setupUi(self, codertool):
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 27, 91, 31))
        ...
        self.label_3.setGeometry(QtCore.QRect(370, 27, 91, 31))
        self.label_3.setObjectName("label_3")
        self.dateTime3 = QtWidgets.QDateTimeEdit(self.tab)
        self.dateTime3.setGeometry(QtCore.QRect(100, 140, 211, 41))
        self.dateTime3.setDateTime(QtCore.QDateTime(QtCore.QDate(2014, 1, 1), QtCore.QTime(0, 0, 0)))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(100, 20, 211, 41))
        self.textBrowser.setObjectName("textBrowser")
        self.textBrowser_2 = QtWidgets.QTextBrowser(self.tab)
        self.textBrowser_2.setGeometry(QtCore.QRect(470, 20, 211, 41))
    ...
    def retranslateUi(self, codertool):
        ...
        self.label_2.setText(_translate("codertool", "当时时间"))
        ...
        self.label_3.setText(_translate("codertool", "当时时间戳："))
        self.dateTime3.setDisplayFormat(_translate("codertool", "yyyy-MM-dd HH:mm:ss"))
